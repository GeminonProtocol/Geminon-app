...
import { FormWarning, FormHelp } from "components/form"
...
import { useFetchAllowance, useInfiniteApprove, useSubmitSwapTx } from "../mint/useContractsSCM"
...
function Tx<TxValues>(props: Props<TxValues>) {
  ...
  const {write: writeSubmit, ...submitStatus} = 
    useSubmitSwapTx(offerAssetItem.address, askAssetItem.address, inAmount, enabled && isApproved)
