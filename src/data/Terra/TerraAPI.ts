...
//   // const networks = useNetworks() // El valor de networks se puede ver en root/networks.json
//   // return mainnet ? networks["mainnet"].api : network.api // mainnet API: https://phoenix-api.terra.dev
// }
...
//   const mainnet = useTerraAPIURL(true) // https://phoenix-api.terra.dev
//   const baseURL = current ?? mainnet
//   const path = "/gas-prices"

//   return useQuery(
//     [queryKey.TerraAPI, baseURL, path], // https://phoenix-api.terra.dev/gas-prices
//     async () => {
//       const { data } = await axios.get<GasPrices>(path, { baseURL })
//       return data // {"uluna": "0.15"}
//     },
...
//   const mockRet: ChartDataItem[] = [{datetime: 0, value: "0"}]
//   return mockRet
...
//   const mockRet = {datetime: "0", value: "0"}
//   return mockRet
